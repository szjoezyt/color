...
const categories = [
    {
        ...
        swatches: [
            ...
            { id: "bz02", name: "BZ-02", image: "images/BZ-02.jpg" },// --- Data Structure ---
const categories = [
    {
        id: "bz",
        name: "BZ-standard color\n9*1220*2440mm",
...
async function exportToPdf() {
    ...
    for (let i = 0; i < selectedSwatches.length; i++) {
        ...
        totalArea += totalSwatchArea;
        summaryItems.push({ name: imageName, quantity: quantity, area: area, totalArea: totalSwatchArea });
